...
import SmsTekilClient from '@/components/iletisim/SmsTekilClient'

export const dynamic = 'force-dynamic'

export default async function SmsTekilPage() {
  ...
  return (
    <div>
      <nav className="flex items-center gap-2 text-sm text-slate-500 mb-4">
        ...
        <span className="text-slate-300">/</span>
        <span className="text-slate-800 font-medium">Tekil Mesajlar</span>
      </nav>

      <div className="mb-5 flex items-center justify-between gap-3 flex-wrap">
        <h1 className="text-2xl font-bold text-slate-800">✉️ Tekil Mesajlar</h1>
        <Link
