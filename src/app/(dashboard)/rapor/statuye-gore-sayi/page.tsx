...
import StatuyeGoreSayiClient, { type StatuyeGoreSayiTabVerisi } from '@/components/rapor/StatuyeGoreSayiClient'
import {
  gelenlerAyrilanlar,
  periyotSonGunu,
...
export default async function StatuyeGoreSayiPage({
  ...
  const tabs: StatuyeGoreSayiTabVerisi[] = periyotlar.map(p => {
    const D = periyotSonGunu(yil, p)
    const snap = statuSayiSnapshot({ D, tanimStatuler, kadro, firma })
