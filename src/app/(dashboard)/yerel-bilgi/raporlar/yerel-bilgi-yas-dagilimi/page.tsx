...
const ACIKLAMA =
  'Yerel Bilgi için yaş dağılımı: 18-25, 26-35, 36-45, 46-55, 56-65, 65+. Yaş hesabı Statüye Göre Yaş Raporu ile aynıdır (anlık görüntü yılı - doğum yılı).'

export default async function YerelBilgiYasDagilimiPage({
  searchParams,
}: {
  ...
  return (
    <StatuyeGoreMatrisRaporClient
      ...
      variant="yas"
      geriHref="/yerel-bilgi/raporlar"
      geriLabel="← Yerel Bilgi — Raporlar"
    />
  )
}
