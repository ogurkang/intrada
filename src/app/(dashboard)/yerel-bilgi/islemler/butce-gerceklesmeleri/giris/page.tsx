...
export default async function ButceGerceklesmeleriGirisPage() {
  ...
  const [
    ...
    supabase
      ...
      .order('id', { ascending: true }),
    mudCozum != null
      ? supabase.from('yerel_bilgi_butce_gider_islem').select('*').eq('mudurluk_id', mudCozum)
  ...
  return (
    <>
      ...
      <YerelBilgiButceMatrisClient
        ...
        kaydetSonrasiHref="/yerel-bilgi/raporlar/butce-gerceklesmeleri"
      />
    </>
  )
}
