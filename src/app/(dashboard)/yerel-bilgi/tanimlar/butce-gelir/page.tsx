...
import {
  ...
  butceGelirToggle,
  butceGelirTopluEkle,
  butceGelirTopluGuncelle,
} from './actions'

export default async function ButceGelirTanimPage() {
  ...
  return (
    <>
      ...
      <YerelBilgiTanimListeClient
        title="Bütçe Gelir Tanımı"
        geriHref="/yerel-bilgi/tanimlar"
        rows={rows}
        topluEkle={butceGelirTopluEkle}
        tekGuncelle={butceGelirGuncelle}
        topluGuncelle={butceGelirTopluGuncelle}
        toggleAktif={butceGelirToggle}
      />
    </>
  )
}
