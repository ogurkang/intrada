...
export async function GET(request: NextRequest) {
  ...
  if (tip === 'detay') {
    ...
    rows.push(mergeSatir('Raporlu Memurlar — Dönem İçindeki İzinler', colCount, { bold: true }))
  ...
  /* ── Özet tipi ──────────────────────────────────────────────────── */
  const headers = ['Sıra No', 'Sicil No', 'Ad Soyad', 'Unvan', 'Önceki Dönemden', 'Rapor', 'Refakatçi İzni', 'Kesilen', 'Sonraki Döneme']
