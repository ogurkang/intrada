...
/** Grup 8 + 40 (mühendis/mimar/şehir plancısı). TH Mühendis satırındaki %160 kopyalanmaz. */
export const MUDUR_KARIYER_OHT_MUHENDIS = '195'
/** Grup 9 + 40 (kimyager). */
export const MUDUR_KARIYER_OHT_KIMYAGER = '185'

export type MudurKariyerTuru = 'muhendis' | 'kimyager'
...
>(
  ...
  const kariyerOht = kariyer === 'kimyager' ? MUDUR_KARIYER_OHT_KIMYAGER : MUDUR_KARIYER_OHT_MUHENDIS
  let sonraki: T = {
    ...puan,
    yan_odeme: mudurKariyerYanOdeme(puan.yan_odeme, opts.destekYardimciBirim),
    oht: ohtMax(puan.oht, kariyerOht),
  }
