...
import KysHubClient from '@/components/kys/KysHubClient'
import type { KysBaslikSatir } from '@/components/kys/KysBaslikListeClient'

export default async function KysHubSayfa({ menuId }: { menuId: number }) {
  ...
  if (baslikError) console.error('KYS_HUB_BASLIK_LOAD_FAILED', baslikError.message)
