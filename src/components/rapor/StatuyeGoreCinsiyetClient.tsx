    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-slate-800">Statüye Göre Cinsiyet Raporu</h1>
          <p className="text-sm text-slate-600 mt-1">
            Aylık sekmelerde liste, o ayın son günü itibarıyla aktif personeli gösterir. YILLIK sekme: yıl sonu (
            31 Aralık) anlık görüntüsü.
          </p>
        </div>
